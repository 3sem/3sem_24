...
1) Находит процесс по его PID (изначально заданный через аругменты командной строки), читает его рабочую директорию и запись на procfs /proc/$pid
